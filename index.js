...
var js_client_1 = require("@fluencelabs/js-client");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var spaces, library, keys, i, input;
        ...
        switch (_a.label) {
            case 0:
                ...
                spaces.map(function (space) {
                    keys.push(process.env[space]);
                });
                i = 0;
                _a.label = 1;
            case 1:
                if (!(i < spaces.length)) return [3 /*break*/, 5];
                return [4 /*yield*/, js_client_1.Fluence.connect(nodes[0].multiaddr, {
                        keyPair: { type: 'Ed25519', source: keys[i] }
                    })];
            case 2:
                _a.sent();
                return [4 /*yield*/, js_client_1.Fluence.getClient()];
            case 3:
                input = (_a.sent()).getPeerId();
                console.log('~~~~~~~');
