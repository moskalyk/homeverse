declare type SomeNonArrowTypes = ScalarType | OptionType | ArrayType | StructType | TopType | BottomType;
export declare type NonArrowType = SomeNonArrowTypes | ProductType<SomeNonArrowTypes>;
...
export declare type BottomType = {
    /**
     * Type descriptor. Used for pattern-matching
     */
    tag: 'bottomType';
 ...
 */
export declare type ScalarNames = 'u8' | 'u16' | 'u32' | 'u64' | 'i8' | 'i16' | 'i32' | 'i64' | 'f32' | 'f64' | 'bool' | 'string';
...
export declare type StructType = {
     ...
     */
    fields: {
        [key: string]: NonArrowType;
    };
};
export declare type LabeledProductType<T> = {
    /**
     * Type descriptor. Used for pattern-matching
     */
    tag: 'labeledProduct';
...
export declare type UnlabeledProductType<T> = {
    /**
     * Type descriptor. Used for pattern-matching
     */
...
export declare type ProductType<T> = UnlabeledProductType<T> | LabeledProductType<T>;
/**
 ...
 */
export declare type ArrowType<T> = {
    /**
     * Type descriptor. Used for pattern-matching
     */
    tag: 'arrow';
 ...
 */
export declare type ArrowWithoutCallbacks = ArrowType<NonArrowType>;
/**
 * Arrow which domain does can contain both non-arrow types and arrows (which themselves cannot contain arrows)
 */
export declare type ArrowWithCallbacks = ArrowType<NonArrowType | ArrowWithoutCallbacks>;
...
export declare const getArgumentTypes: (def: FunctionCallDef) => {
    [key: string]: NonArrowType | ArrowWithoutCallbacks;
};
export declare const isReturnTypeVoid: (def: FunctionCallDef) => boolean;
export {};
