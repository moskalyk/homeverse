 ...
 */
export declare type CallServiceResultType = JSONValue;
/**
 * Generic call service handler
 */
export declare type GenericCallServiceHandler = (req: CallServiceData) => CallServiceResult | Promise<CallServiceResult>;
/**
