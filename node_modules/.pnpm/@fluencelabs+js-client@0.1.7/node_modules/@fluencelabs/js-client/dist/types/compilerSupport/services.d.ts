...
import { ArrowWithoutCallbacks, FunctionCallConstants, FunctionCallDef, NonArrowType, IFluenceInternalApi } from '@fluencelabs/interfaces';
 ...
 */
export declare const injectRelayService: (def: FunctionCallDef, peer: IFluenceInternalApi) => {
    serviceId: string;
    fnName: string;
    handler: () => {
        retCode: ResultCodes;
...
export declare const registerParticleScopeService: (peer: IFluenceInternalApi, particle: Particle, service: ServiceDescription) => void;
export declare const registerGlobalService: (peer: IFluenceInternalApi, service: ServiceDescription) => void;
